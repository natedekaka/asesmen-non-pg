  ...
  <div class="rounded-2xl bg-white p-6 shadow">
    ...
    <form method="post" class="space-y-4">
      ...
      <div class="flex gap-3">
        <button type="submit" class="flex-1 rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-indigo-700 transition-colors">
          Simpan Perubahan
        </button>
        <a href="/admin/index.php" class="flex-1 rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-center text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
          Batal
        </a>
      </div>
    </form>
